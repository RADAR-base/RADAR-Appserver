...
class TaskRepositoryImpl(
    ...
    override suspend fun findByUserIdAndType(
        ...
        createQuery(
            "SELECT t FROM Task t WHERE t.userId = :userId AND t.type = :type",
            Task::class.java,
        )
            .setParameter("userId", userId)
    ...
    override suspend fun deleteByUserId(userId: Long): Unit = transact {
        createQuery("DELETE FROM Task t WHERE t.userId = :userId")
            .setParameter("userId", userId)
            .executeUpdate()
    }
    ...
    override suspend fun deleteByUserIdAndType(
        ...
        createQuery(
            "DELETE FROM Task t WHERE t.userId = :userId AND t.type = :type",
        )
            .setParameter("userId", userId)
            .setParameter("type", type)
            .executeUpdate()
    ...
    override suspend fun existsByIdAndUserId(id: Long, userId: Long): Boolean = transact {
        createQuery(
            "SELECT COUNT(t) FROM Task t WHERE t.id = :id AND t.userId = :userId",
            Long::class.java,
        )
            .setParameter("id", id)
            .setParameter("userId", userId)
    ...
    override suspend fun existsByUserIdAndNameAndTimestamp(
        ...
        createQuery(
            "SELECT COUNT(t) FROM Task t WHERE t.userId = :userId AND t.name = :name AND t.timestamp = :timestamp",
            Long::class.java,
        )
            .setParameter("userId", userId)
    ...
    override suspend fun findByIdAndUserId(id: Long, userId: Long): Task? = transact {
        createQuery(
            "SELECT t FROM Task t WHERE t.id = :id AND t.userId = :userId",
            Task::class.java,
        )
            .setParameter("id", id)
            .setParameter("userId", userId)
