...
package org.radarbase.appserver.microservices.core.factory.eventBus

import com.google.common.eventbus.EventBus
import jakarta.inject.Inject
import org.glassfish.jersey.internal.inject.DisposableSupplier
import org.radarbase.appserver.microservices.core.config.CoreEventBusConfig
import org.radarbase.appserver.microservices.core.event.AppserverEventBus
...
class EventBusFactory @Inject constructor(
    ...
    private val appserverEventBus = AppserverEventBus(
        checkNotNull(config.numThreads) {
