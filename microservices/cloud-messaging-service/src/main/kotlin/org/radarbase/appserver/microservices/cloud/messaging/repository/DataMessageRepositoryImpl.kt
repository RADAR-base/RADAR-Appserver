...
class DataMessageRepositoryImpl @Inject constructor(
    ...
    override suspend fun findByUserId(userId: Long): List<DataMessage> = transact {
        createQuery(
            "SELECT d FROM DataMessage d WHERE d.userId = :userId",
    ...
    override suspend fun findByIdAndUserId(
        ...
        createQuery(
            "SELECT d FROM DataMessage d WHERE d.id = :id AND d.userId = :userId",
            DataMessage::class.java,
        )
            .setParameter("id", id)
            .setParameter("userId", userId)
    ...
    override suspend fun deleteByUserId(userId: Long): Unit = transact {
        createQuery("DELETE FROM DataMessage d WHERE d.userId = :userId")
            .setParameter("userId", userId)
            .executeUpdate()
    }
