...
class QuartzNotificationJobListener @Inject constructor(
    ...
    override fun jobWasExecuted(context: JobExecutionContext, jobException: JobExecutionException?) {
        ...
        when (type) {
            ...
            else -> logger.warn("The message type does not exist.")
        }
    }

    companion object {
        private val logger: Logger = LoggerFactory.getLogger(QuartzNotificationJobListener::class.java)
    }
}
