...
package org.radarbase.appserver.microservices.notification.event.listener
...
@Suppress("unused")
class NotificationStateEventListener @Inject constructor(
    ...
    fun onNotificationStateChange(event: NotificationStateEventDto) {
        ...
        logger.info("New notification state event - ID: {}, STATE: {}", event.notification.id, event.state)
    ...
    companion object {
        private val logger: Logger = LoggerFactory.getLogger(NotificationStateEventListener::class.java)
    }
}
