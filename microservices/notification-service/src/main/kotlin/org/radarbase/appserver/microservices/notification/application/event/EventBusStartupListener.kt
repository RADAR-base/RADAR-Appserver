...
package org.radarbase.appserver.microservices.notification.application.event
...
class EventBusStartupListener @Inject constructor(
    ...
    override fun onEvent(event: ApplicationEvent) {
        if (event.type == ApplicationEvent.Type.INITIALIZATION_FINISHED) {
            val notificationListener = serviceLocator.getService(
                NotificationStateEventListener::class.java,
            )

            eventBus.register(notificationListener)
        }
    }
