...
package org.radarbase.appserver.microservices.notification.event.listener.quartz
...
class QuartzNotificationSchedulerListener @Inject constructor(
    ...
    override fun jobScheduled(trigger: Trigger) {
        ...
        when (type) {
            ...
            else -> logger.warn("Job is scheduled for unknown message type")
        }
    }
    ...
    companion object {
        ...
        private val logger: Logger = LoggerFactory.getLogger(QuartzNotificationSchedulerListener::class.java)
    }
}
