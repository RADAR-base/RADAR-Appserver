...
dependencies {
    ...
    integrationTestImplementation("io.mockk:mockk:${Versions.mockkVersion}")
    integrationTestImplementation("org.mockito.kotlin:mockito-kotlin:${Versions.mockitoKotlinVersion}")
    integrationTestImplementation("org.hamcrest:hamcrest:${Versions.hamcrestVersion}")
    integrationTestImplementation("org.assertj:assertj-core:${Versions.assertjVersion}")
