...
class                                                                                                                                                                                       NotificationEndpointAuthTest {
    ...
    @Test
    fun getUnAuthorizedNotificationsForUser(): Unit = runBlocking {
    ...
    @Test
    fun getUnAuthorizedNotificationsForProject(): Unit = runBlocking {
        val response = httpClient.get(
    ...
    @Test
    fun postUnauthorizedNotificationForUser(): Unit = runBlocking {
    ...
    @Order(1)
    @Test
    fun postNotificationForUser(): Unit = runBlocking {
        val response = httpClient.post(
            "$PROJECT_PATH/$DEFAULT_PROJECT/$USER_PATH/$DEFAULT_USER/$NOTIFICATION_PATH",
        ) {
            setBody(notification)
    ...
    @Order(2)
    @Test
    fun postBatchNotificationForUser(): Unit = runBlocking {
    ...
    @Test
    fun getNotificationsForUser(): Unit = runBlocking {
        val response = httpClient.get(
            "$PROJECT_PATH/$DEFAULT_PROJECT/$USER_PATH/$DEFAULT_USER/$NOTIFICATION_PATH",
        ) {
            accept(ContentType.Application.Json)
    ...
    @Test
    fun getNotificationsForProject(): Unit = runBlocking {
        val response = httpClient.get(
            "$PROJECT_PATH/$DEFAULT_PROJECT/$NOTIFICATION_PATH",
        ) {
            accept(ContentType.Application.Json)
    ...
    @Test
    fun viewForbiddenNotificationsForOtherUser(): Unit = runBlocking {
        val response = httpClient.get(
    ...
    @Test
    fun viewForbiddenNotificationsForOtherProject(): Unit = runBlocking {
        val response = httpClient.get(
