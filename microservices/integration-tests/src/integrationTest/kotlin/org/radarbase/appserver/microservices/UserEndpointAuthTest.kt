...
class UserEndpointAuthTest {
    ...
    @BeforeEach
    fun postDefaultProject(): Unit = runBlocking {
    ...
    @Test
    fun viewUnauthorizedSingleUser(): Unit = runBlocking {
    ...
    @Test
    fun createUnAuthorizedUser(): Unit = runBlocking {
    ...
    @Test
    @Order(3)
    fun getUsersInProject(): Unit = runBlocking {
    ...
    @Test
    @Order(4)
    fun viewForbiddenUsersInOtherProject(): Unit = runBlocking {
